    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">Danh sách đăng ký mở tài khoản</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body table-responsive">
                    ...
                    <form action="{{ route('users.actionStatusOpenAccount') }}">
                            ...
                            <tbody>
                                @foreach ($listRegisters as $key => $listRegister)
                                    <tr>
                                        ...
                                        <td
                                            style="color:{{ $listRegister->status_contact == 'Đã mở' ? 'green' : 'red' }}">
                                            {{ $listRegister->status_contact }}</td>
                                        <td>
                                            <a href="{{ route('users.registerOpenAccount.edit', $listRegister->id) }}"
