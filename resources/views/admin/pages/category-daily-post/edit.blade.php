    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Cập nhật danh mục bài viết</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
            ...
            <div class="card-box">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        @endif
                        <form action="{{ route('category-daily-post.update', $categoryDailyPost->id) }}" method='post'>
                            @method('PUT')
                            @csrf
                            <div class="form-group">
                                <label for="cate">Tên danh mục</label>
                                <input type="text" class="form-control" id="cate" placeholder="Nhập tên danh mục..."
                                    name="name" value="{{ $categoryDailyPost->name }}">
                                @error('name')
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" id="position" name="position" min="1" max="100" class="form-control"
                                    ...
                                    value="{{ $categoryDailyPost->position }}">
                                @error('position')
