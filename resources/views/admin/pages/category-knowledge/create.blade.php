    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Thêm mới danh mục kiến thức chung</h4>
            ...
            <div class="card-box">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        @endif
                        <form action="{{ url('admin/categoryKnowledges') }}" method="post">
                            @csrf
                            ...
                            {{-- <button type="submit"
                                class="btn btn-purple waves-effect waves-light">Tạo mới</button>
                            --}}
