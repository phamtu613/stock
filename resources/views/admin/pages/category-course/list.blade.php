...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <a href="{{ route('categoryCourses.create') }}" class="text-white d-inline-block mb-3"><button type="button"
                    ...
                    <div class="table-responsive">
                        <table class="table m-0">
                            ...
                            <tbody>
                                @if ($categoryCourses->total() > 0)
                                    @foreach ($categoryCourses as $key => $categoryCourse)
                                        <tr>
                                            <th scope="row">{{ $key + 1 }}</th>
                                            <td>{{ $categoryCourse->name }}</td>
                                            <td>{{ $categoryCourse->position }}</td>
                                            <td colspan="2">
                                                <a href="{{ route('categoryCourses.edit', $categoryCourse->id) }}"
                                                ...
                                                <a href="#custom-modal-{{$categoryCourse->id}}" class="d-inline-block" data-animation="fadein"
                                                ...
                                                <!-- Modal -->
                                                <div id="custom-modal-{{$categoryCourse->id}}" class="modal-demo">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <form
                                                            action="{{ route('categoryCourses.destroy', $categoryCourse->id) }}"
                                                            method="post">
                                                            @method('DELETE')
                                                            @csrf
