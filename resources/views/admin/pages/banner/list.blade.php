...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <a href="{{ route('banners.create') }}" class="text-white d-inline-block mb-3"><button type="button"
                                ...
                                @if ($banners->total() > 0)
                                    @foreach ($banners as $key => $banner)
                                        <tr>
                                            ...
                                            <td>{{ $banner->name }}</td>
                                            <td><img src="{{ url($banner->image) }}" alt="banner" width="100px"
                                                    height="50px" style="object-fit: cover"></td>
                                            <td>{{ $banner->position }}</td>
                                            <td colspan="2">
                                                <a href="{{ route('banners.edit', $banner->id) }}" class="d-inline-block">
                                                    <button type="button"
                                                        class="btn btn-icon waves-effect waves-light btn-info mr-2"
                                                        title="Chỉnh sửa"> <i class="mdi mdi-square-edit-outline"></i>
                                                        Sửa</button>
                                                </a>
                                                <a href="#custom-modal-{{ $banner->id }}" class="d-inline-block"
                                                ...
                                                <!-- Modal -->
                                                <div id="custom-modal-{{ $banner->id }}" class="modal-demo">
