    ...
    this.gallerySelector.forEach(function (galleryContainer, i) {
        ...
        galleryContainer
            ...
            .forEach(function (imageItems, key) {
                ...
                var newImages = "";
                newImages += `<div class="gallery-items" data-toggle="tooltip" data-placement="right" title="Click vào hình để xem rõ hơn" style="cursor: zoom-in;background: url(${imageItems.src}) center / cover; "></div>`;
